        ...
        if (this.config.shouldUseSauce()) {
            return this.paramedicSauceLabs.runSauceTests.apply(this.paramedicSauceLabs)
                ...
                .then(isAppiumTestPassed => {
                    logger.normal(`cordova-paramedic results (SauceLabs): isTestPassed = ${isTestPassed}, isAppiumTestPassed = ${isAppiumTestPassed}`);
                    return isTestPassed === utilities.TEST_PASSED && isAppiumTestPassed === utilities.TEST_PASSED;
                });
        // Not Sauce Labs
        } else {
            return this.runLocalTests()
                ...
                .then(isAppiumTestPassed => {
                    logger.normal(`cordova-paramedic results (local): isTestPassed = ${isTestPassed}, isAppiumTestPassed = ${isAppiumTestPassed}`);
                    return isTestPassed === utilities.TEST_PASSED && isAppiumTestPassed === utilities.TEST_PASSED;
                });
        }
    }
